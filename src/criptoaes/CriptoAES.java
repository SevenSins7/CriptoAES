...
//                                 byte[] senha_final = senha.getBytes("UTF-8");
    ...
    public void run() {
        gerarChave();
//        do {
//                tmpTextoDecriptado = decriptarMensagem(textoEncriptado, Char_Final);
//                if (tmpTextoDecriptado != null) {
//                    this.tc.setTextoDecriptado(tmpTextoDecriptado);
//                }
//
//                if (!this.fromTail) {
//                    rootIndex++;
